...
namespace DB_LAB
{
    ...
    public partial class Delete_Ward : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (con.State == System.Data.ConnectionState.Open) ;
            {
                ...
                {
                    string q = "Delete from ward where w_ID= " + dlt.Text.ToString()+"and w_ID <> 20 and w_type='Isolation'";
                    SqlCommand cmd = new SqlCommand(q, con);
                    cmd.ExecuteNonQuery();
                   
                    SqlCommand ccmd = new SqlCommand();
                    MessageBox.Show("Isolation Ward " + dlt.Text.ToString() + " removed Successfully!");
                    con.Close();
                    con.Open();
                    ...
                    {
                        q = "insert into PatientAdmit values (" +itm+ ",20,getdate(),NULL); update ward set NoOfPatients = NoOfPatients + 1, beds = beds - 1 where w_id = 20";
