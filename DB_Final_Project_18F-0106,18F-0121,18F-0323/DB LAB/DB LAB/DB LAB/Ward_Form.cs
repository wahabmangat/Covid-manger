...
namespace DB_LAB
{
    public partial class Ward_Form : Form
    {
        public Ward_Form()
        {
            InitializeComponent();
        ...
        private void Ward_Form_Load(object sender, EventArgs e)
        {
                ...
                if (txtWID.Text.ToString() != String.Empty && txtBED.Text.ToString() != String.Empty && txtPAT.Text.ToString() != String.Empty && txtLOC.Text.ToString() != String.Empty && txtNAME.Text.ToString() != String.Empty)
                {
                    ...
                    if (!flag)
                    {
                        ...
                        if (comboBox1.SelectedIndex == 0)
                            q = "insert into Ward values(" + txtWID.Text.ToString() + "," + txtBED.Text.ToString() + ",0,'" + txtLOC.Text.ToString() + "','Public','" + txtNAME.Text.ToString() + "','Isolation');";
                        else if (comboBox1.SelectedIndex == 1)
                            q = "insert into Ward values(" + txtWID.Text.ToString() + "," + txtBED.Text.ToString() + ",0,'" + txtLOC.Text.ToString() + "','Private','" + txtNAME.Text.ToString() + "','Isolation');";
        ...
        private void Ward_Form_Load_1(object sender, EventArgs e)
        {
